...
let allCaps = runners.map(
  runner => runner.first_name.toUpperCase() + " " + runner.last_name
);
console.log(allCaps);
...
// Problem 2
const companies = [];
runners.map(runner => companies.push(runner.company_name));
